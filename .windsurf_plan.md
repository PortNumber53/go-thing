...
## Slack Home Tab Support (2025-08-14)
  ...
  - Micro-optimization (2025-08-23): Reuse a single `strings.NewReplacer` per render to escape mrkdwn (`&`, `<`, `>`) instead of creating a new replacer each loop iteration. File: `utility/slack.go`.
