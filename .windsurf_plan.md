...
## Slack Home Tab Support (2025-08-14)
  ...
  - Performance (2025-08-23): Avoid repeated config I/O by caching config in `utility/slack.go` using `sync.Once` (`getConfig()`), used by `SendSlackResponse()` and `PublishSlackHomeTab()`.
